<template>
    <div class="collect bgf">
      ...
      <!--<div class="detail-head pl3 tc pr3 relative">
        ...
        <span class="fs36 cfff">优质卖家</span>
      ...
      <div class="bgf pl3 pr3">
        <ul>
          <li class="flex flex-align-center h100"  v-for="item in list">
            ...
            <a href="javascript:;" class="z-bluek fs26" v-if="item.good_type==1" @click="addattention(item.cid,4)">取消加入</a>
            <a href="javascript:;" class="z-bluek fs26" v-if="item.good_type==0" @click="addattention(item.cid,2)">加入</a>
          </li>
        </ul>
      </div>
    </div>
