      ...
      <div class="box-list">
        ...
        <div class="pb40 z-bdb pl3 pr3 bgf" v-for="item in orderDao">
          <p class="flex flex-align-center pt40">
            <span class="c0 flex-1 fs28"><i class="z-cu mr20">热</i>{{item.model_code}}</span>
...
<script>
  import {buyersOrderListdo,buyersOrderDetailsdo,alipayPaydo,deleteOrderdo} from 'api/interfacemethod'
  import {sellerRmOrderdo} from 'api/interfacemethod'
