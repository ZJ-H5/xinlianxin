    ...
    <div class="payOrder">
      <div class="head">
        <div class="detail-head pl3 tc pr3 relative">
          ...
          <span class="fs36 cfff">付款成功</span>
        </div>
      </div>

      <div class="content">
        <div class="msg-content">
          <img :src="icon" alt="" class="msg-icon">
          <p class=" pb30 f34 c0">
            付款成功
          </p>
          <p class=" pb30 f28 c6 pl3 pr3 lh50">
            恭喜您购买成功，如果需要查看更多商品，请浏览下方的推荐热卖产品,或者继续购买其他商品
          </p>
        </div>
        <p class="z-title">
          推荐产品
...
<script>
import { Clocker,XDialog,Msg } from 'vux'
...
export default {
  ...
  methods:{
    goback () {
      this.$router.replace('/purchaseOrder/qb')
    }
  }
