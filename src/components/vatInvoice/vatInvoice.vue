<template>
  <div class="vatInvoice">
    <ul class="fptxt clr">
      ...
      <li class="flex">
        <span class="fptxtl">公司地址</span>
        <span class="fptxtr flex-1"><input type="text" placeholder="请输入" @blur="blurs" v-model="obj.companyAddress"/></span>
      </li>
      <li class="flex">
        <span class="fptxtl">公司电话</span>
        <span class="fptxtr flex-1"><input type="text" placeholder="请输入" v-model="obj.companyPhone"/></span>
      </li>
      <li class="flex">
      ...
      <li class="flex">
        <span class="fptxtl">开户银行</span>
        <span class="fptxtr flex-1"><input type="text" placeholder="请输入" @blur="blurs" v-model="obj.bankName"/></span>
      </li>
      <li class="flex">
        <span class="fptxtl">开户银行账号</span>
        <span class="fptxtr flex-1"><input type="text" placeholder="请输入" @blur="blurs" v-model="obj.bankCode"/></span>
      </li>
      <li class="flex">
      ...
      <li>
        <textarea class="txtbx" placeholder="请填写详细地址" v-model="obj.address" @blur="blurs" maxlength="30"></textarea>
      </li>
    </ul>
    <div class="mt40">
      <group>
...
export default {
  ...
  created(){
    ...
    if(this.$route.params.item){
      ...
      this.obj.companyAddress=item.companyAddress
      this.obj.companyPhone=item.companyPhone
      ...
      this.obj.id=item.id
      this.obj.bankName=item.bankName
      this.obj.bankCode=item.bankCode
    }
  },
  methods: {
    turn: function () {
