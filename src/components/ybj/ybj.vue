<template>
  <div>
      ...
      <div class="box-list">
        ...
        <div class="bgf mb20" v-for="(item,index) in list" :class="{'bdt':index!=0}">
          <div class="pl3 pr3 bdb">
            ...
            <div class="flex flex-align-center fs28">
              ...
              <div >
                ...
                <p>
                  ...
                  <span class="c0 ml20">{{item.quoted_delivery_time}}天</span>
                </p>
              </div>
            </div>
            ...
            <div class="flex flex-align-center fs28" v-if="item.sellerRemark!==''">
              <p class="flex-1 lh80">
          ...
          <p class="clr pt20 pb20 bdb pl3 pr3 flex flex-align-center">
            ...
            <a href="javascript:;" class="z-bluek" @click="bj(item.id,index)">重新报价</a>
          </p>
        </div>
      </div>
    </scroll>
    ...
    <x-dialog :show="bjshow" default="1231313131" @on-hide="cartDialog" @on-show="dialogShow">
      <div class="bgf2">
        <div class="bgf mb20">
...
<script>
  import {myOfferListdo,AppofferInitdo,AppagainOfferdo} from 'api/interfacemethod'
    ...
    methods:{
      ...
      _myOfferListdo(){
        myOfferListdo({
          ...
          if(res.code==1){
            ...
            this.loadflag = false
            this.list.push(...(res.data.list)) //已报价的列表
      ...
      _AppagainOfferdo(){
        AppagainOfferdo({
          ...
          if(res.code==1){
            ...
            this.bjshow=false
            this.list[this.index].quantity=this.offerNum
            this.list[this.index].quoted_delivery_time=this.offerFutures
            this.list[this.index].quoted_price=this.offerUnit
            this.list[this.index].seller_remark=this.offerNote
            this._myOfferListdo()
            console.log('报价成功')
          }
      ...
      _AppofferInitdo(){
        AppofferInitdo({
          ...
          if(res.code==1){
            this.offerNum=res.data.quoted_quantity
            this.offerUnit=res.data.quoted_price/100
            this.offerNote=res.data.remark
            this.offerFutures=res.data.quoted_delivery_time
          }
